        ...
        <table class="table table-striped table-bordered table-hover" style="margin-bottom: 0px">
            ...
            <tbody>
                ...
                foreach ($result as $r) {
                    ...
                    echo "<td class='col-xs-1'>".$r['review']."</td>";
                    ...
                    echo "<td class='col-xs-2'><img src='images/".$r['image']."' alt='".$r['image']."' class='img-thumbnail bookImage'></td>";
                    echo "<td class='col-xs-1'><a href='submitBook.php?id=".$r['book_id']."' class='btn btn-primary' style='display: block'>Edit</a></td>";
                    echo "<td class='col-xs-1'><a href='delete.php?book_id=".$r['book_id']."' onclick='return confirm(\"Are you sure?\");' class='btn btn-primary' style='display: block'>Delete</a></td></tr>";
                }
                ?>
            </tbody>
        </table>
